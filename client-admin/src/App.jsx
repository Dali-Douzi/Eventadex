...
import RegistrantDetail from './pages/RegistrantDetail';
import VipRegistrantDetail from './pages/VipRegistrantDetail';
    ...
    <BrowserRouter>
      ...
      <AuthProvider>
        <Routes>
          ...
          {/* Badge pages run outside the dashboard layout (no sidebar/navbar) */}
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/admin/registrants/:id"     element={<RegistrantDetail />} />
              <Route path="/admin/vip-registrants"          element={<VipRegistrants />} />
              <Route path="/admin/vip-registrants/:id"   element={<VipRegistrantDetail />} />
